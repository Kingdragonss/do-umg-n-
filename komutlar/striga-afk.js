...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
   ...
   message.channel.send(new MessageEmbed().setColor('BLACK').setDescription(`<a:atnstar:828285899522965524> ${kullanıcı} Başarıyla Afk Oldunuz Afk Olmanızın Sebebi: **${ramo}**`));
